...
const int triggerPinSensor1 = A0;
...
const int triggerPinSensor2 = A1;
...
const int triggerPinSensor3 = A2;
...
const int triggerPinSensor4 = A5;
...
void loop() {
  ...
  if(DISTANCE1 > 0 && DISTANCE1 < 61 ){
    Serial.printf("Ultrasonic Sensor 1 is %i \n", DISTANCE1);
    delay(100);
    }
  ...
  if(DISTANCE4 > 0 && DISTANCE4 < 250 ){
    Serial.printf("Ultrasonic Sensor 4 %i \n", DISTANCE4);
   // delay(100);
    }  
}
